...
const articles = [
      ...
      "sections": [
        ...
        },
        {
          ...
          "list": [
            ...
            "Improved Performance: Contextual targeting increases ad engagement by showing products relevant to the current content."
          ]
        }
      ]
    }
      ...
      "sections": [
        ...
        },
        {
          ...
          "list": [
            ...
            "Bottom-of-Funnel (BOF): Conversion-focused ads that drive action."
          ]
        },
        {
   ...
   */
  {
      ...
      "articleContent": {
          "sections": [
              {
                  "title": "About",
                  "content": "LOHILO was founded in 2014 with a vision to create an ice-cream that not only was delicious, but also healthy enough to be a post work-out snack. This resulted in the creation of the worlds first high protein, low fat, and low carb ice-cream. Which, of course, tastes fantastic. LOHILOs recipe for success didn't stop there though, they applied the strong brand to more verticals within high quality functional foods. Today, LOHILO is listed on the Stockholm stock market with products nation-wide in Sweden and a fast growing e-commerce, selling products within fashion, functional foods and drinks."
              },
              {
                  "title": "Challenge",
                  "content": "The Swedish functional foods company, LOHILO, quickly made a name for themselves in 2014 when they filled store freezers with an ice-cream full of protein and less sugar and fat than its competitors. Today, the company offers a wide range of “delicious and nutritious” food products. However, many of LOHILOs products were limited to in-store consumers and a e-commerce was needed to grow further. To increase e-commerce sales, programmatic advertising would prove to be an important key for success. With RtiBid's platform, ad placements are optimised automatically which enables high reach while still being cost-efficient. By also using retargeting ads, LOHILO could convert potential customers that previously visited the site without buying anything. The programmatic campaigns also had tangible effects in the stores: “We see a clear connection between our digital advertising and our fast growth. Even if the customer doesn't take action directly after seeing the ad, our brand stays top-of-mind and the consumers learn about our products”, says LOHILO CEO Richard Hertvig."
              },
              {
                  "title": "Results",
  ...
  },
  {
      "id": "Cases2",
      "image": case1,
      "metaTitle": "Herbmed – Demanding Challenges. Creative Solutions.",
      "metaDescription": "Due to many digital advertising channels restricting ads for the CBD industry, Herbmed needed a scalable solution. With RtiBid's platform and skilled customer success team, Herbmed has not only maintained a ROAS above 329% but also developed and fine-tuned its messaging.",
      "articleContent": {
          "sections": [
              {
                  "title": "About",
                  "content": "Since 2015 Herbmed has been at the forefront of the CBD industry, including products such as CBD oils or skincare. The e-Commerce follows a vision to create opportunities for everyone to use safe and natural CBD products. Few CBD brands have been in the game as long as Herbmed. They only use ethically-sourced CBD extract from a trusted supplier. They also use independent test labs to ensure high-quality products across the range. Herbmed focuses much of its communication on educating consumers about the benefits of CBD products. CBD products can for example be used as pain relief, in supplements, or with skincare."
              },
              {
                  "title": "Challenge",
                  "content": "Even though all psychoactive substances are removed from CBD oils and creams, the industry is still widely misunderstood. Consequently, Herbmed has an uphill climb in its marketing efforts. Herbmed's main marketing activities are centered around website content, e-mail activities, influencers, and organic social media. Due to many digital advertising channels, such as Facebook and Google Ads, restricting ads for the CBD industry, Herbmed needs a scalable solution. This requires a channel to grow their brand awareness, minimize distrust, and lead the effort to educate their market about the proven benefits of CBD products. Whilst increasing sales and maintaining a positive ROI."
              },
              {
                  "title": "Results",
  ...
  },
  {
      "id": "Cases3",
      "image": case2,
      "metaTitle": "Zen Pırlanta Increases Brand Awareness Through Personalized Streaming Video Ads",
      "metaDescription": "Staying ahead of competitors with high-reach visibility campaigns.",
      "numList": [
        {
  ...
  },
  {
      "id": "Cases4",
      "image": case3,
      "metaTitle": "Tıkla Gelsin Leverages Deep Learning for Winning In-APP Campaign",
      "metaDescription": "Turkish food delivery app increases revenue with AI-powered retargeting.",
      "numList": [
        {
            name: "Share of total conversions",
            value: "7%"
        },
        {
            name: "Higher conversion value than the target",
            value: "86%"
        },
        {
      ...
      "articleContent": {
          "sections": [
              {
                  "title": "About the client",
                  "content": "Tıkla Gelsin is an ecommerce platform and mobile delivery application established and run by TFI TAB Food Investments. Tıkla Gelsin offers the products of TAB Gıda's operating brands, including Burger King, Popeyes, Arby's, Subway, Sbarro, Usta Dönerci, Usta Pideci and other ecosystem brand Amasya Et Ürünleri. Platform users can find hundreds of tastes ranging from burgers to doner kebab, salads to soups, and pizzas to lahmacun with just one click. Tıkla Gelsin users also benefit from exclusive and customized promotions from their favorite restaurants and earn Tıkla Para bonuses with their orders to redeem for following orders. \n All mentioned brands are registered trademarks."
              },
              {
                  "title": "What they say about us",
                  "content": "\"RtiBid's Deep Learning-powered technology exceeded our expectations. Their communicative account management and strategy team helped build up our campaign scale and bring outstanding results. The static banner campaign was a big success and it is exciting for us to think about what RtiBid can bring in the future with the dynamic retargeting campaigns. Our advanced partnership with RtiBid is built on trust and results—both key for any successful collaboration.\" Nihan Gürsoy, Performance Marketing Senior Specialist TAB Gıda – Tıkla Gelsin"
              },
              {
                  "title": "The challenge",
                  "content": "Tıkla Gelsin was already working with RtiBid to optimize their web retargeting campaigns. However, the client wanted to quickly launch an in-app campaign focused on increasing revenue, with ROI a high priority for the first months. Excited about leveraging the potential of their app through retargeting, Tıkla Gelsin challenged RtiBid to demonstrate the campaign's effectiveness from the outset. In such a competitive landscape, with numerous other huge brands present in the sector, and with the client's high expectations, it was a significant challenge."
              },
              {
                  "title": "The solution",
                  "content": "We implemented two distinct campaigns supplemented by best-in-class static banners. The first was aimed at convincing existing users to make a first food purchase through an offer that awarded a discount for taking this important step. The second campaign focused on brand loyalty. As Tıkla Gelsin had a program that granted coupons to customers for repeat orders, we agreed with the client to feature the coupon itself on the banners."
              },
              {
                  "title": "The result",
                  "content": "For every month of the campaigns, RtiBid was able to exceed the expected KPIs, including 86% more ROAS on average from November to December. The campaigns also exceeded the client's expectations of revenue generation—again by 86% more than the target, and with a 30%+ conversion rate. During the campaigns, 7.67% of Tıkla Gelsin's total conversions came by way of RtiBid. Campaign performance increased each month and the client's satisfaction was demonstrated with a budget increase of 100%. The partnership continues, stronger than ever, with the shared aim of mining the full potential of Tıkla Gelsin's campaigns."
              }
          ]
      }
  },
  {
      "id": "Cases5",
      "image": case4,
      "metaTitle": "Holdit – Effective Programmatic For eCommerce",
      "metaDescription": "Holdit, a Sweden-based mobile accessories company, diversified their marketing mix to include programmatic, complementing their other marketing activities and providing valuable insights into their customers.",
      "articleContent": {
          "sections": [
              {
                  "title": "Meet Holdit",
                  "content": "Holdit was ahead of the game when it came to mobile accessories. After spotting a hole in the market, the Sweden-based company rose to the occasion, creating stylish and easy-to-grip silicone shells. After quickly becoming popular with customers and retailers, Holdit's product portfolio has expanded significantly. Holdit initially operated under a B2B model selling to other retailers but launched a direct-to-consumer (D2C) ecommerce in 2017. True to their motto of “We know color, just choose your vibe.”, Holdit's 100% vegan products bring a stylish, Scandinavian touch that resonates with the brand's target audience. As a company, Holdit's vision is to be the first choice for trendy mobile accessories whenever someone buys a new device. Holdit strives for transparency with its sustainability goals and has committed to reaching climate neutrality by 2025–all while prioritizing diversity and equity. \n We spoke with Adam Lindh, Chief Digital Officer at Holdit, and his team about how the company has successfully built a brand and grown its business with strategic omnichannel marketing, including programmatic advertising."
              },
              {
                  "title": "Challenge",
                  "content": "When it comes to digital marketing for D2C ecommerce, Holdit uses a holistic approach to reach its target audience of fashion-forward young people aged 18-34. Holdit uses organic, paid, and influencer marketing on social media – Instagram, TikTok, YouTube, Snapchat, they've got it covered. Holdit has four teams that work close together to manage and deliver paid media, generate demand, and ultimately drive conversions. These internal collaborations help uncover synergies between content and performance. According to Adam, “Based on our data, we give our content team a brief of material needed and then evaluate what's working and what's not. Of course, measured depending on the goal of the campaign and platform.” Holdit relies on analytics to understand what's in demand throughout the customer journey. “We try to have a good balance between upper funnel and lower funnel,” says Adam. “When it comes to the upper funnel we focus on branding campaigns, with the goal being high reach, engagement and low CPM.” Once potential customers are mid-funnel, metrics like quality traffic, CTR and CPC become more important. At the bottom of the funnel, the focus is on running campaigns with high return on ad spend (ROAS) and lower cost per acquisition (CPA)."
              },
              {
                  "title": "Why Add Programmatic for Ecommerce?",
                  "content": "Of course, different channels play different roles for consumers throughout their journey. While many ecommerce businesses turn to programmatic advertising for high-ROAS lower-funnel conversion campaigns, Holdit has been using RtiBid to grow the top of the funnel as a complement to other marketing activities. “A common issue with digital marketing is being dependant of Google,” says Adam. “We strive to distribute our budget across several platforms so that we're not dependant on a single platform. RtiBid is a great complement for us in this regard.“ After identifying the need to diversify Holdit's marketing mix to include programmatic, Adam brought RtiBid on board in October of 2022. After just a few weeks, Holdit's programmatic campaigns were exceeding goals and providing valuable insights into their customers. “We get so much more information from RtiBid about our campaigns. We even see how long it takes for someone to make a purchase after seeing or clicking on an ad, which is great” says Adam. This information is critical for Holdit to understand their audience and meet their needs: “We get a better idea of ​​what our customer journey looks like. Even if we have a fairly price-friendly product, it can still take a couple of days before someone makes the purchase. You might think that purchases usually happen straight away, but it usually doesn't. Even though it is a fairly cheap product, we see customers still need to have a couple of interactions with Holdit to complete the purchase.”"
              },
              {
                  "title": "Results",
                  "content": "When selling products at a lower price point, high-ROAS campaigns can be hard to come by. Even so, Holdit's campaigns are exceeding their ROAS goals and driving major impressions and traffic: 2.80X (Goal: 2X), 10,442 clicks, 3.2 million impressions"
              },
              {
                  "title": "A Programmatic Partner",
                  "content": "In addition to its easy self-serve platform, RtiBid offers managed service for customers. For Holdit, that means meeting with their client success manager about every week. Adam says: “It's one of those things that I appreciate a lot with RtiBid: we get a very good support that we are in contact with every week. We are super satisfied.” We asked Adam if he had any tips about the role of programmatic ads in digital marketing for ecommerce brands, and he shared this wisdom: “When you want to enter a new market or if you want to further establish yourself in a market, programmatic display advertising is a good way to go. It should be seen as a strong complement to the other channels. RtiBid and programmatic advertising is an effective way to spread one's brand.” “Even though we are established in the nordic markets, you can always grow and you have to be on your toes and fill the funnel with new traffic that never ends. And there it is a big advantage that we can reach out to as many people as possible with programmatic display.”"
              }
          ]
      }
  },
  ...
  
  {
      ...
      "articleContent": {
          "sections": [
              ...
              {
                  "title": "What they say about us",
                  "content": "\"The partnership with RtiBid was instrumental in increasing the scale of retargeting campaigns on WestwingClube and WestwingNow. Our budget allocation was even more effective with them, which drove revenue growth and stable YOY ROI, even during Black Friday, the most challenging and competitive period for us in Brazil.\" Samantha Araujo, Head of Growth at Westwing"
              },
              {
                  "title": "The challenge",
                  "content": "Black Friday is the busiest period for retail in Brazil and a major focus for interior design brands. However, in 2022, it coincided with the opening weekend of the football World Cup, meaning any promotions would have to compete for the nation's attention. RtiBid had to bring greater scale and revenue to Westwing's two websites while maintaining their ROI goals all in a fast-paced, highly competitive retail sector."
              },
              {
                  "title": "The solution",
                  "content": "RtiBid and Westwing worked closely to develop the best media strategy to deliver on campaigns goals. To anticipate Black Friday, account managers divided Westwing products into categories and promotional periods and created highly engaging dedicated banners for retargeting campaigns. This strategy helped drive additive sales throughout the month. Our Deep Learning-powered campaigns maximized conversions by delivering targeted, personalized ads, with relevant product recommendations, to customers who were ready to buy."
              },
              {
                  "title": "The result",
                  "content": "Despite the World Cup opening and a 1% YOY drop in Black Friday month ecommerce sales in Brazil*, Westwing campaigns carried out with RtiBid exceeded the company's established goals. They brought in an 81% increase in revenue from October to November 2022, while keeping a stable ROI. Compared to the previous November, the campaigns achieved a 70% increase in revenue. Deep Learning-powered ad campaigns are able to better serve relevant ad creatives to individuals and predict buyer intent. This better use of campaign resources led to much more compelling results for Westwing during Black Friday."
              }
          ]
      }
  }
